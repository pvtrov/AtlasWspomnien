...
def parse_photo_create(
    ...
    try:
        ...
        logger.warning(
            "Photo upload form validation failed: category_slug=%r location_text=%r taken_year=%r taken_month=%r taken_day=%r errors=%s",
            category_slug,
            location_text,
            taken_year,
            taken_month,
...
def upload_photo(
    ...
    logger.info(
        "Photo upload requested: owner_id=%s filename=%r category_slug=%r location_text=%r taken_year=%r taken_month=%r taken_day=%r description_length=%s",
        current_user.id,
        file.filename,
